...
var palabras = ['ALURA', 'AHORCADO', 'HTML', 'ORACLE', 'JAVASCRIPT', 'LOGICA', 'PROGRAMACION', 'DESAFIO', 'COMPILAR', 'USUARIO'];
...
// captura el id "btn-guardar", guardar la palabra agregada e inicia el juego
...
function guardarPalabra() {
  ...
  if(nuevaPalabra !== ""){
    ...
    // haz que los componentes de la pantalla de agregar palabra desaparezcan
